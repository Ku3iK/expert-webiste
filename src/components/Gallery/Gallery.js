...
const Gallery = ({ images }) => {
    ...
    return (
        <div>
            {images.map((el, index) => <GalleryImage key={index} src={el.image.url} index={index} handleActivateBrowser={handleActivateBrowser} alt={"obrazek w galeri"} />)}
            {
                isBrowserActive
                    ? (
                        <ImageBrowser>
                            <img src={images[activeImageIndex].image.url} alt="" />
